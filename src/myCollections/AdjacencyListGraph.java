...
//	 */
//	private List<List<Pair<V, Double>>> adjacencyLists;
//	
//	/**
...
//		isDirected = false;
//		adjacencyLists = new ArrayList<List<Pair<V, Double>>>();
...
//			List<Pair<V, Integer>> vList = (List<Pair<V, Double>>) new ArrayList<Pair<V, Double>>();
...
//			vList.add(new Pair<V, Double>(v, 0));
...
//			adjacencyLists.get(ValueU).add(new Pair<V, Double>(v, w));
//	//		System.out.println(adjacencyLists.get(ValueU));
//			adjacencyLists.get(ValueV).add(new Pair<V, Double>(u, w));
//		
//		}else {
